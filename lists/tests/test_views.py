...
class HomePageTest(TestCase):
    ...
    def test_home_page_uses_item_form(self):
        response = self.client.get('/')
        self.assertIsInstance(response.context['form'], ItemForm) # type: ignore
...
class ListViewTest(TestCase):
    ...
    def test_displays_only_items_for_that_list(self):
        ...
        Item.objects.create(text='itemey 2', list=correct_list) # type: ignore
    ...
    def test_passes_correct_list_to_template(self):
        ...
        correct_list = List.objects.create()
        response = self.client.get(f'/lists/{correct_list.id}/')
        self.assertEqual(response.context['list'], correct_list) # type: ignore
    ...
    def test_displays_item_form(self):
        list_ = List.objects.create()
        response = self.client.get(f'/lists/{list_.id}/')
        self.assertIsInstance(response.context['form'], ExistingListItemForm) # type: ignore
...
class NewListViewUnitTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.request.user = Mock() # type: ignore

    @staticmethod
    def patch_mock_list_to_have_get_absolute_url(mockFormClass):
        mock_form = mockFormClass.return_value
        mock_form.save.return_value.get_absolute_url = lambda: '1'

    def test_passes_POST_data_to_NewListForm(self, mockNewListForm):
        self.patch_mock_list_to_have_get_absolute_url(mockNewListForm)  
...
class MyListsTest(TestCase):
    ...
    def test_passes_correct_owner_to_temlate(self):
